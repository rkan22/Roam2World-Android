...
private fun MoreBottomNav(
    ...
    Card(
        ...
        Row(
            ...
            MoreNavText("Home", onDashboard)
            MoreNavText("Packages", onPackages)
            MoreNavText("Wallet", onWallet)
            MoreNavText("eSIMs", onEsims)
            Text(
                text = "More",
                color = orange,
...
@Composable
private fun MoreNavText(text: String, onClick: () -> Unit) {
    Text(
        text = text,
        color = Color(0xFF6B7280),
        style = MaterialTheme.typography.labelLarge,
